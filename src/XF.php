...
class XF
{
	 ...
	 * @var integer
	 */
	public static $version = '2.2.7 Patch 1';
	public static $versionId = 2020771; // abbccde = a.b.c d (alpha: 1, beta: 3, RC: 5, stable: 7, PL: 9) e

	const XF_API_URL = 'https://xenforo.com/api/';
	const XF_LICENSE_KEY = 'pm8WHvdHbWp4lPdbUwmvwL5nC1ZdDdIT';
